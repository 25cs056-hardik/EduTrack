...
export default function InviteMember() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!email.trim()) {
            toast({ title: "Error", description: "College email is required.", variant: "destructive" });
            return;
        }
        ...
        try {
            ...
            if (error) {
                console.error("Supabase invitation insert error:", error);
            ...
            toast({
                ...
                description: `Invitation sent to ${name} successfully.`,
            });
            navigate("/team");
        } catch (err: any) {
