        ...
        try {
            ...
            if (githubUrl.trim() && urlChanged) {
                ...
                try {
                    ...
                    if (data) {
                        githubData = data;
                        toast({ title: "GitHub Updated", description: `Repository "${data.repo_name}" linked successfully.` });
                    } else {
                        throw new Error("Could not fetch data");
                    }
                } catch (err: any) {
                    toast({ title: "GitHub Warning", description: `Could not fetch repo data. Keeping existing data.`, variant: "destructive" });
